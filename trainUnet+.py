...
from Denoise.Img_denoise.models.unetTorch_residual import Unet
...
if __name__ == '__main__':
    ...
    # Load model------------------------------------------------------------------------------------------------------
    model_ckpt = "/home/zhoujiazhou/PycharmProjects/code/Denoise/Img_denoise/runs/Unet+50.9/models/best_model.pth"
