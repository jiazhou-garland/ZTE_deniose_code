...
class BaseModel():
    ...
    def model_to_device(self, net):
        """Model to device. It also warps NAF_model with DistributedDataParallel
        or DataParallel.
    ...
    def save_network(self, net, net_label, current_iter, param_key='params'):
        ...
        save_path = os.path.join(self.opt['path']['NAF_model'], save_filename)
    ...
    def _print_different_keys_loading(self, crt_net, load_net, strict=True):
        """Print keys with differnet name or different size when loading NAF_model.
